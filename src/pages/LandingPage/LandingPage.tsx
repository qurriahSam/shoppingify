      ...
      <div className='hero-content flex-col lg:flex-row-reverse'>
        ...
        >
          <div>
            ...
            <p className='py-6'>
              Streamline your grocery shopping with our intuitive shopping list
              app. Easily create and organize lists. Never forget an item again
              with customizable categories. Simplify your errands and stay
      ...
      <div className='hero-content flex-col lg:flex-row'>
        ...
        <div className='md:ml-12 md:w-2/5'>
          ...
          >
            ...
            <p className='py-6'>
              Welcome to our innovative shopping list app, designed to
            ...
            <div className='card card-side shadow-xl p-3 items-center'>
              ...
              <div className='card-body p-2'>
                ...
                <p className='md:text-xs'>
                  Our app streamlines the shopping process, saving you time and
                  effort by allowing you to create and organize your shopping
          ...
          >
            <div className='card card-side shadow-xl p-3 items-center mt-4'>
              ...
              <div className='card-body p-2'>
                ...
                <p className='md:text-xs'>
                  Tailor your lists to your specific needs with customizable
                  categories and item suggestions, ensuring that you never miss
                  an essential item again.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className='card card-side shadow-xl p-3 items-center mt-4'>
              ...
              <div className='card-body p-2'>
                ...
                <p className='md:text-xs'>
                  Keep track of your spending by setting budget limits and
                  monitoring your expenses within the app, helping you to stick
                  to your financial goals while shopping.
                </p>
              </div>
            </div>
          </motion.div>
...
function Reviews() {
  ...
  function Review({
    ...
    person: { name: string; img: string; comment: string };
  }) {
    return (
  ...
  return (
    <div className='hero min-h-screen'>
      <div className='hero-content flex-col'>
        <h1 className=' font-extrabold font-["Playfair_display"] text-3xl'>
          Testimonials
        </h1>
...
function Footer() {
  return (
    <>
      <footer className='footer px-10 pt-10 bg-yellow-700 text-neutral-content'>
        <aside>
          <p className='text-3xl font-["Rakkas"]'>Shoppingify</p>
        </aside>
        <nav className='md:col-end-12 flex'>
      ...
      <div className='divider bg-yellow-700 pt-2 m-0'></div>
      <footer className='footer p-10 bg-yellow-700 text-neutral-content'>
        <nav>
          <h6 className='footer-title'>About</h6>
          <a className='link link-hover'>About Us</a>
          <a className='link link-hover'>Documentation</a>
          <a className='link link-hover'>Learn Stories</a>
